...
public class LyricsFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null){
            mTitle = LyricsFragmentArgs.fromBundle(getArguments()).getTitle();
            mArtist = LyricsFragmentArgs.fromBundle(getArguments()).getArtist();
        }else{
            mTitle = "";
            mArtist = "";
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mParentView = inflater.inflate(R.layout.fragment_lyrics, container, false);
...
//        mResponseView   = mParentView.findViewById(R.id.responseView);
    ...
    private static void startNotFoundActivity(FragmentActivity fragmentActivity,
        ...
        new FancyAlertDialog.Builder(fragmentActivity)
                ...
                .OnPositiveClicked(() -> {
                    LyricsFragmentDirections.ActionLyricsFragmentToListMusicFragment action =
                            LyricsFragmentDirections.actionLyricsFragmentToListMusicFragment(title, artist);
...
//                    responseView.setText(responseOrion.getSong().getText());
                ...
                // If invalid response
                    ...
                    LyricsFragment.startNotFoundActivity(activity, activity.getApplicationContext(),view, song, artist);
                }
            }
        }
    }
